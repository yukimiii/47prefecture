...
d = {
	...
	'山陽線':[['','姫路','西川原'],['','三原','北長瀬'],['快速サンポート','福山','倉敷'],['特急いなば','鳥取','上郡'],['寝台特急サンライズ出雲・瀬戸','東京','姫路'],],
	'瀬戸大橋線':[['快速マリンライナー','高松',random.choice(['備前西市','妹尾','早島'])],['特急しおかぜ','松山','児島'],['特急南風','高知','児島'],['','児島','大元'],['快速','茶屋町','大元'],['・宇野みなと線','宇野','大元'],],
